...
This is a system and analysis tool for personal finances.
It is an ETL complete system, with clear steps to:
* Monitor personal finance information in spreadsheet;
* Functionality to import expenses data from a csv generated by my bank account, to the expected format of my finances;
* Save every month expense report in a folder to have it analyzed with python code, that will transform them to make a new file, with my complete historic.
