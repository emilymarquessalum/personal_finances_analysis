...
## Automations:
* Future implementations will have functionality to import expenses data from a csv generated by a bank account, to reconcile the current informed expenses to the real expenses;
...
### Making cuts 
Use money discounted from dynamic expenses (such as transportation, eating out...). The ways to achieve that are discussed in [this topic](add-here-the-big-chapter-where-i-discuss-how-to-best-work-with-these-types-of-costs)
